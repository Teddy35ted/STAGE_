# Script simple pour initialiser l'administrateur
$body = @{
...
try {
    ...
    $response = Invoke-RestMethod -Uri "http://localhost:3002/api/admin/init" -Method POST -Body $body -ContentType "application/json"
