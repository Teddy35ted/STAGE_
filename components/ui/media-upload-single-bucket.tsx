...
import { AppwriteMediaService, MediaUploadResult, MediaUploadProps, MediaCategory } from '../../lib/appwrite/media-service-single-bucket';
...
// Hook pour utiliser facilement l'upload avec le bucket unique
export function useMediaUpload(category: MediaCategory, userId?: string, entityId?: string) {
  const [isUploading, setIsUploading] = useState(false);
