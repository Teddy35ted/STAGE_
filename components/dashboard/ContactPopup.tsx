...
export const ContactPopup: React.FC<ContactPopupProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-green-50/90 via-emerald-50/90 to-teal-50/90 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white/95 backdrop-blur-md shadow-2xl shadow-green-500/20 rounded-2xl border border-white/20 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
